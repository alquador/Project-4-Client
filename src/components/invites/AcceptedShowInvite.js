...
const AcceptedShowInvite = (props) => {
// setting state here
            ...
            <Container className="fluid" id="showContainer">
                    <Card className='shadow p-3 mb-5 bg-body rounded mt-3'>
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <small>Playdate Scheduled! </small><br/>
                                </Col>
                        </Card.Text>
                    ...
                    <Card.Footer style={{
                        textAlign: 'center'
                            ...
                            <Button onClick={() => setModalOpen(true)} className="m-2" variant="primary">
                                Reschedule Playdate!
                            </Button>
                            {/* } */}
                    </Card.Footer>                        
...
export default AcceptedShowInvite